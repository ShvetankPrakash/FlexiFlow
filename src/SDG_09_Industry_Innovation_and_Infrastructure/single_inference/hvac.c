...
char predict_random_forest(unsigned short temperature, unsigned short humidity, unsigned short light, unsigned short co2, unsigned short humidity_ratio);
...
char Read_Sensor_Values_Run_RF() {
    ...
    temperature = Temperature_Sensor_Sample_Input;
    humidity = Humidity_Sensor_Sample_Input;
    light = Light_Sensor_Sample_Input;
    co2 = CO2_Sensor_Sample_Input;
    humidity_ratio = HumidityRatio_Sensor_Sample_Input;
